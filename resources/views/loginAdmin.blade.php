...
<head>
    <title>ForoMultitema-InicioSesionAdmin</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
            ...
            <div class="col-11 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                ...
                <div class="card shadow-sm card-responsive">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <h2 class="text-center mb-3 form-title-responsive">
                            <i class="fas fa-user me-1"></i>Iniciar Sesión Administrador
                        </h2>

                        <form action="{{ route('loguearAdmin') }}" method="post">
                            @csrf
                              @if (session('mensaje'))
